...
<div class="right">{{< figure src="/img/assets/oralington_postcard.png" alt="" >}}</div>
...
</div><h3>How to use the map</h3><div class="pageblock"><div class="right">{{< figure src="/img/assets/show-map.jpg" alt="" >}}</div>
<div class="main">
