...
<div class="right">{{< figure src="/img/assets/graph_childrenUS2.png" alt="" >}}</div>
...
</div><div class="pageblock"><div class="maintext"><div class="left">{{< figure src="/img/assets/graph_children_poverty2.png" alt="" >}}</div>
...
<div class="right">{{< figure src="/img/assets/graph_cavity_children.png" alt="" >}}</div>
...
<div class="right">{{< figure src="/img/assets/graph_likelihood2.png" alt="" >}}</div>
